...
export default function AdminDashboard() {
  ...
  const { data: analyticsData, isLoading: analyticsLoading } =
    useQuery<AnalyticsData>({
      ...
      queryFn: () =>
        api
          .get(
            `/admin/analytics?startDate=${dateRange.start}&endDate=${dateRange.end}`
          )
          .then((res) => res.data),
  ...
  const { data: equipmentData, isLoading: equipmentLoading } =
    useQuery<EquipmentData>({
      queryKey: ["adminEquipment"],
      queryFn: () => api.get("/admin/equipment").then((res) => res.data),
      enabled: activeTab === "equipment",
    });

  const { data: maintenanceData, isLoading: maintenanceLoading } = useQuery<MaintenanceData>({
    queryKey: ["adminMaintenance"],
    queryFn: () => api.get("/maintenance/alerts").then((res) => res.data),
                        ...
                        {editingSession === session.id ? (
                          <div className="flex items-center space-x-2">
                            <input
                              ...
                              value={tempCapacity}
                              onChange={(e) =>
                                setTempCapacity(parseInt(e.target.value) || 0)
                              }
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <button
                              onClick={() =>
                                startEditing(session.id, session.capacity)
                              }
                              disabled={updateCapacityMutation.isPending}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow p-6">
                      ...
                      <p className="text-3xl font-bold text-blue-600">
                        {analyticsData.summary.totalCustomers}
                      </p>
                    </div>
                    <div className="bg-white rounded-lg shadow p-6">
                      <h3 className="text-lg font-semibold text-gray-900">
                      ...
                      <p className="text-3xl font-bold text-purple-600">
                        £
                        {analyticsData.summary.totalEquipmentRevenue.toFixed(2)}
                      </p>
                    </div>
                    <div className="bg-white rounded-lg shadow p-6">
                      <h3 className="text-lg font-semibold text-gray-900">
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-medium">
                            £
                            {analyticsData.incomeBreakdown.subscriptionRevenue.toFixed(
                              2
                            )}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-medium">
                            £
                            {analyticsData.incomeBreakdown.equipmentRevenue.toFixed(
                              2
                            )}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-medium">
                            £
                            {analyticsData.incomeBreakdown.proteinSupplementRevenue.toFixed(
                              2
                            )}
                          </span>
                        </div>
                              ...
                              .map((customer, index) => (
                                <tr key={index} className="border-b">
                                  ...
                                  <td className="text-right py-2">
                                    £{customer.subscriptionSpending.toFixed(2)}
                                  </td>
                                  <td className="text-right py-2">
                                    £{customer.gearSpending.toFixed(2)}
                                  </td>
                                </tr>
                              ))}
                          </tbody>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-blue-600">
                            {analyticsData.equipmentAnalysis.totalOrders}
                          </p>
                        </div>
                        <div>
                          <h4 className="font-medium text-gray-900">
                          ...
                          <p className="text-2xl font-bold text-green-600">
                            £
                            {analyticsData.equipmentAnalysis.totalRevenue.toFixed(
                              2
                            )}
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-2xl font-bold text-purple-600">
                            {
                              analyticsData.equipmentAnalysis.popularItems
                                .length
                            }
                          </p>
                        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow p-6">
                      ...
                      <p className="text-3xl font-bold text-red-600">
                        {financialData.summary.failedPayments.count}
                      </p>
                      <p className="text-sm text-gray-500">
                        £
                        {financialData.summary.failedPayments.amount.toFixed(2)}{" "}
                        lost
                      </p>
                    </div>
                    <div className="bg-white rounded-lg shadow p-6">
                      ...
                      <p className="text-3xl font-bold text-yellow-600">
                        {financialData.summary.pendingPayments.count}
                      </p>
                      <p className="text-sm text-gray-500">
                        £
                        {financialData.summary.pendingPayments.amount.toFixed(
                          2
                        )}{" "}
                        pending
                      </p>
                          ...
                          >
                            ...
                            <div className="flex space-x-4 text-sm">
                              ...
                              <span className="text-blue-600">
                                Sub: £{day.subscription.toFixed(2)}
                              </span>
                              <span className="text-purple-600">
                                Gear: £{day.gear.toFixed(2)}
                              </span>
                            </div>
                          </div>
                        ))}
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-2xl font-semibold text-gray-900">
                            {equipmentData.gearItems?.length || 0}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-2xl font-semibold text-gray-900">
                            {equipmentData.gearItems?.filter(
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-2xl font-semibold text-gray-900">
                            {equipmentData.recentOrders?.length || 0}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-2xl font-semibold text-gray-900">
                            £
                            {equipmentData.orderStatistics
                              ?.reduce(
                                (sum: number, stat: any) =>
                                  sum + (stat.totalValue || 0),
                                0
                              )
                              ?.toFixed(2) || "0.00"}
                          </p>
                          ...
                          {equipmentData.gearItems?.map((item: any) => (
                            <tr key={item.id} className="hover:bg-gray-50">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap">
                                <button
                                  onClick={() =>
                                    toggleItemStatus(item.id, !item.isActive)
                                  }
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Enter sizes separated by commas, or leave blank if not
                  applicable
                </p>
              </div>
